...
\begin{itemize}
    \item Section~\ref{sec:intro} provides a brief literature review, followed
        by an overview of the dataset and its clustering;
...
concerned with the analysis of these models. Queuing theory is a mature
...
and the simulating of queues can be found
...
\begin{figure}[htbp]
    \centering%
    \resizebox{\imgwidth}{!}{\input{queue}}
...
\begin{figure}[htbp]
    \centering
    \resizebox{\imgwidth}{!}{\input{birth_death_mm1}}
    \caption{
...
\begin{figure}[htbp]
    \centering
    \resizebox{\imgwidth}{!}{\input{birth_death_mmc}}
    \caption{
...
work employs a single node using the \(M/M/c\) queue to model a hypothetical
