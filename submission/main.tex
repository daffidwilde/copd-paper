...
\begin{table}
    \centering
    \resizebox{\tabwidth}{!}{\input{tex_comparison}}
...
\begin{figure}
    \centering
    \begin{subfigure}{.5\imgwidth}
        \includegraphics[width=\linewidth]{img_lambda_time_logscale}
...
\begin{figure}
    ...
    \end{subfigure}\hfill%
    \begin{subfigure}{.5\imgwidth}
        \includegraphics[width=\linewidth]{img_servers_utilisation}
...
\begin{figure}
    \centering
    \includegraphics[width=\imgwidth]{img_moving_time_logscale}
    \caption{%
