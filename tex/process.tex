...
\begin{tikzpicture}
    ...
    \node[fill=blue!50, minimum width=20mm, rounded corners] (c0) at (0, 85mm)
        {Cluster 0};
    \node[fill=green!50, minimum width=20mm, rounded corners] (c1) at (0, 75mm)
        {Cluster 1};
    \node[fill=orange!50, minimum width=20mm, rounded corners] (c2) at (0, 65mm)
        {Cluster 2};
    \node[fill=pink!50, minimum width=20mm, rounded corners] (c3) at (0, 55mm)
        {Cluster 3};
