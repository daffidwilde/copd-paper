\begin{abstract}
    ...
    theory, and the recovery of queuing parameters from incomplete data. This is
    done despite common limitations in operational research with regard to the
    availability of fine-grained data as this work only uses administrative
    hospital spell data from those patients.
