...
visualisation due to the widespread and near uniform distribution of their
lengths of stay.
...
by intervention does not. For instance, despite Cluster 2 making up the majority
of the population, the spells within that cluster are atypical of the
population's CCI distribution and are heavily skewed towards the minimal value.
This skewness is also apparent in the spells with both interventions but not in
the remaining plots in Figure~\ref{fig:intervention_charlson}.
